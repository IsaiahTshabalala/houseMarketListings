                ...
                {expanded &&
                    <>
                        <div className='w3-margin-top'>
                            ...
                            {                            
                                transactionTypes.toSorted().map(transType=>
                                    (<div key={transType}>
                                        <input id={`${ids.transactionTypes}-${transType}`} class="w3-padding-small w3-radio" type="radio" name="transactionType" value={transType} checked={selectedTransType === transType} 
                        ...
                        <div className='w3-margin-top w3-padding-small'>
                            <input type='checkbox' className='w3-padding-small' name='offersOnly' checked={offersOnly} onChange={handleOffersOnlyChanged}/>
                            ...
                            <div id={ids.propertyTypes}>
                                {
                                    propertyTypes.toSorted().map(propType=> (
                                        <div key={propType}>
                                            <input id={`${ids.propertyTypes}-${propType}`} class="w3-padding-small w3-check" type="checkbox" checked={selectedPropTypes.includes(propType)}
                            ...
                            <div id={ids.numBedrooms}>
                                {
                                    numberOfBedrooms.toSorted().map(num=> (
                                        <div key={num}>
                                            <input id={`${ids.numBedrooms}-${num}`} class="w3-padding-small w3-check" type="checkbox" checked={selectedNumBedrooms.includes(num)}
