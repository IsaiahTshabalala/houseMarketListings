        ...
        <div className='w3-border w3-round w3-padding-small dropdown' style={isDisabled? { pointerEvents: 'none'}: {}}>
            ...
            <div className='w3-padding-small'>
                ...
                <div className='input-wrapper'>
                    <div>
                        <input className={`w3-input-theme-1 w3-input dropdown-input`} autoComplete='off'
            ...
            <div className={`w3-padding-small w3-input-theme-1 w3-margin-left w3-dropdown-content w3-bar-block ${showItems && 'w3-show'}`} id='dropDown' name='dropDown' disabled={isDisabled} aria-label={label} >
                {list.map((item, index)=> {
                        return (
